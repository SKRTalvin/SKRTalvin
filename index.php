    ...
    <body>
        ...
        <nav class="navbar navbar-default navbar-fixed-top" role="navigation">
            <div class="container-fluid">
                ...
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="index.php"><img alt="Brand" src="assets/img/spcc.png" height="40px"></a>
                </div>
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <form class="form" role="form" method="POST" accept-charset="UTF-8" >
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" name="icPatient" placeholder="Student Number" required>
                                                </div>
                                                <div class="form-group">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <form action="<?php $_PHP_SELF ?>" method="POST" accept-charset="utf-8" class="form" role="form">
                                        ...
                                        <input type="number" name="icPatient" value="" class="form-control input-lg" placeholder="Your Student Number"  required/>
        ...
        <section id="promo-1" class="content-block promo-1 min-height-600px bg-offwhite">
            <div class="container">
                <div class="row">
                    <div class="col-md-5">
                        <h2>This is Appointment Schedule Today</h2>
                        <p>This is Nurse Schedule. Please <span class="label label-danger">Login</span> to make an appointment. </p>
        ...
        <section id="content-1-9" class="content-1-9 content-block">
            <div class="container">
                <div class="underlined-title">
                    <h1>Systems Plus Computer College</h1>
                    <hr>
                    <h2>About Systems Plus Computer College (SPCC)</h2>
                </div>
                <div class="row">
                    <div class="col-md-4 col-sm-12 col-xs-12 pad25">
                        ...
                        <div class="col-xs-10">
                            <h4>Mission</h4>
                            <p>Systems Plus Computer College is committed to provide liberal, quality, transformative, and relevant education towards the holistic development of all stakeholders through excellence in instruction, research, and extension services.</p>
                        </div>
                    </div>
                    <div class="col-md-4 col-sm-12 col-xs-12 pad25">
                        <div class="col-xs-2">
                        ...
                        <div class="col-xs-10">
                            <h4>Philosophy</h4>
                            <p>Commitment to excellence to serve God and the Community.</p>
                        </div>
                    </div>
                    <div class="col-md-4 col-sm-12 col-xs-12 pad25">
                        <div class="col-xs-2">
                        ...
                        <div class="col-xs-10">
                            <h4>Vision</h4>
                            <p>A leading and globally competitive institution of learning through service and innovation.</p>
                        </div>
                    </div>
                </div>
                <!-- /.row -->
        ...
        <div class="copyright-bar bg-black">
            <div class="container">
                <p class="pull-left small">© Appointment Schedule for <a href ="https://www.facebook.com/SPCCCaloocanOfficial"> SPCC Caloocan</a></p>
                <p class="pull-right small"><a href="adminlogin.php">Admin Login</a></p>
                <br>
                
                <p class="pull-right small"><a href="medical/index.php">Inventory System Login</a></p>
