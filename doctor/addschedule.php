...
<html lang="en">
    <head>
        ...
        <title>Appointment Schedule <?php echo $userRow['doctorFirstName'];?> <?php echo $userRow['doctorLastName'];?></title>
        <!-- Bootstrap Core CSS -->
            ...
            <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
                ...
                <div class="collapse navbar-collapse navbar-ex1-collapse">
                    <ul class="nav navbar-nav side-nav">
                        ...
                        <li class="active">
                            <a href="addschedule.php"><i class="fa fa-fw fa-table"></i> Nurse Schedule</a>
                        </li>
                        <li>
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <ol class="breadcrumb">
                                <li class="active">
                                    <i class="fa fa-calendar"></i> Add your Schedule Here
                                </li>
                            </ol>
                        </div>
                    </div>
